...
main = do
    putStrLn "rab4hm vs. greedy:"
    let greedyResults = doSimulation rab4hmList greedyList
    print greedyResults
    summarize greedyResults "rab4hm" "greedy"
    --
    putStrLn "rab4hm vs. rab4hm:"
    let rab4hmResults = doSimulation rab4hmList rab4hmList
    print rab4hmResults
    summarize rab4hmResults "rab4hm" "rab4hm"
    --
    putStrLn "rab4hm vs. rab6hm:"
    let rab6hmResults = doSimulation rab4hmList rab6hmList
    print rab6hmResults
    summarize rab6hmResults "rab4hm" "rab6hm"
    --
    putStrLn "rab4hm vs. rab4gr:"
    let rab4grResults = doSimulation rab4hmList rab4grList
    print rab4grResults
    summarize rab4grResults "rab4hm" "rab4gr"
    --
    return ()
